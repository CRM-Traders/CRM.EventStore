...
using CRM.EventStore.Application.Common.Specifications;
using CRM.EventStore.Domain.Common.Entities;
using CRM.EventStore.Persistence.Databases;
using CRM.EventStore.Persistence.Specifications;
using Microsoft.EntityFrameworkCore;

namespace CRM.EventStore.Persistence.Repositories.Base;
