using CRM.EventStore.Api.Common.Middlewares;
using CRM.EventStore.Application.Common.Synchronizer;
using CRM.EventStore.Application.DI;
using CRM.EventStore.Infrastructure.DI;
using CRM.EventStore.Persistence.DI;
